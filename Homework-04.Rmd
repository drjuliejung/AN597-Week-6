...
So far, the non-log model seems like a much better fit! However, my log model seems flawed - and the 0 point yields an error and the predicted and CI fits don't seem very accurate. This certainly is a factor to consider when deciding which model is the more accurate. 