...
--> The slope, β1 is the EXPECTED CHANGE in units of y for every 1 unit of change in x. For every gram of increase in brain size, we can expect to see an increase in longevity of β1 months. 
...
ci <- predict(beta1, newdata = data.frame(weight = 150), interval = "confidence", 
